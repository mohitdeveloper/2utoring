...
namespace StandingOutIdentity.Filters.GlobalException
{
    public class GlobalExceptionFilter : IExceptionFilter, IDisposable
    {
        ...
        public GlobalExceptionFilter(ILoggerFactory loggerFactory, IErrorLogService errorLogService, IHostingEnvironment env)
        {
