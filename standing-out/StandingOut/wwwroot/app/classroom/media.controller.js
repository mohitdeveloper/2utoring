    ...
    angular.module('standingOut.controllers').controller('MediaController',
        ['$scope', '$rootScope', 'SessionMediasService', '$sce', 'ModalService', 'DeleteService',
            function ($scope, $rootScope, SessionMediasService, $sce, ModalService, DeleteService) {
                ...
                $scope.fullPaneView = function (index, itemClass) {
                    debugger;
                    
                    for (var i = 0; i < $scope.mediaItems.length; i++) {
                        if (i == index) {
                            if ($scope.selectedPane == 'full') {
                                debugger;
                                if ($scope.mediaItems[i].type == 'Iframe') {
                                    $('.iframe__'+itemClass).css('padding-bottom','100%');
                                }
                                if ($scope.mediaItems[i].type == 'Embed') {
                                    $('.embed__'+itemClass).css('padding-bottom','35%');
                                }
                            }
                            ...
                            if ($scope.selectedPane == 'half') {
                                ...
                                if ($scope.mediaItems[i].type == 'Embed') {
                                    $('.embed__' + itemClass).css('padding-bottom', '50%');
                                }
                            }
                            ...
                            //else {
                            //    if ($scope.mediaItems[i].type == 'Iframe') {
                            //        $('.Browser .iframe__container').css('padding-bottom', '100%');
                            //    }
                            //    if ($scope.mediaItems[i].type == 'Embed') {
                            //        $('.Browser .embed__container').css('padding-bottom', '52.25%');
                            //    }
                            //}
                ...
                $scope.standardView = function (itemClass) {
                    for (var i = 0; i < $scope.mediaItems.length; i++) {
                        //$('.Browser .iframe__container, .Browser .embed__container').css('padding-bottom', '52.25%');
                        $('.iframe__' + itemClass).css('padding-bottom', '52.25%');
                        $('.embed__' + itemClass).css('padding-bottom', '52.25%');
                        $scope.mediaItems[i].fullScreen = false;
                        $scope.mediaItems[i].display = true;
                    }
                };
