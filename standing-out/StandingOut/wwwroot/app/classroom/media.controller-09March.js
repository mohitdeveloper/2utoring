                        ...
                        if (i == index) {
                            if ($scope.selectedPane == 'half') {
                                if ($scope.mediaItems[i].type == 'Iframe') {
                                    $('.Browser .iframe__container, .Browser .embed__container').css('padding-bottom', '100%');
                                }
                                if ($scope.mediaItems[i].type == 'Embed') {
                                    $('.Browser .iframe__container, .Browser .embed__container').css('padding-bottom', '50%');
                                }
                            } else {
                                if ($scope.mediaItems[i].type == 'Iframe') {
                                    $('.Browser .iframe__container, .Browser .embed__container').css('padding-bottom', '100%');
                                ...
                                if ($scope.mediaItems[i].type == 'Embed') {
                                    $('.Browser .iframe__container, .Browser .embed__container').css('padding-bottom', '35%');
                                }
                            }
