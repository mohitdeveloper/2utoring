        ...
        public async Task Get()
        {
            ...
            try
            {
                ...
                using (var context = new DbEntities(options))
                {
                    ...
                    IClassSessionService _Service = new ClassSessionService(_UnitOfWork, _AppSettings);
        ...
        public async Task GetById()
        {
            ...
            try
            {
                ...
                using (var context = new DbEntities(options))
                {
                    ...
                    var firstItem = context.ClassSessions.FirstOrDefault();

                    if(firstItem != null)
                    {
                        var item = await _Service.GetById(firstItem.ClassSessionId);
        ...
        public async Task Delete()
        {
            ...
            try
            {
                ...
                using (var context = new DbEntities(options))
                {
                    ...
                    if (firstItem != null)
                    {
                        await _Service.Delete(firstItem.ClassSessionId);
                        Assert.True(true);
                    }
                }
            }
