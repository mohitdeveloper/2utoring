...
var SessionMediaService = /** @class */ (function () {
    function SessionMediaService(http) {
        this.http = http;
        this.serviceHelper = new index_1.ServiceHelper();
    }
    SessionMediaService.prototype.getByClassSession = function (id) {
    ...
    SessionMediaService.prototype.create = function (model) {
        return this.http.post(this.serviceHelper.baseApi + '/api/sessionMedias', model, { headers: this.serviceHelper.buildHeader() });
    };
    SessionMediaService.prototype.delete = function (id) {
        return this.http.delete(this.serviceHelper.baseApi + '/api/sessionMedias/' + id, { headers: this.serviceHelper.buildHeader() });
    };
    SessionMediaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], SessionMediaService);
    return SessionMediaService;
}());
exports.SessionMediaService = SessionMediaService;
//# sourceMappingURL=session-media.service.js.map