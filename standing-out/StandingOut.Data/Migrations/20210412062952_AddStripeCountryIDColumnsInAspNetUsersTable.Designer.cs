...
namespace StandingOut.Data.Migrations
{
    ...
    [Migration("20210412062952_AddStripeCountryIDColumnsInAspNetUsersTable")]
    partial class AddStripeCountryIDColumnsInAspNetUsersTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StandingOut.Data.Models.Company", b =>
                {
                    ...
                    b.Property<bool>("ProfileFieldsAllComplete");
                    ...
                    b.Property<bool>("ProfileSetupStarted");
            ...
            modelBuilder.Entity("StandingOut.Data.Models.NotificationMessage", b =>
                {
            ...
            modelBuilder.Entity("StandingOut.Data.Models.PageNotificationMessage", b =>
                {
                    b.Property<Guid>("PageNotificationMessageId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("PageNotificationMessageId");

                    b.ToTable("PageNotificationMessages");
                });
            ...
            modelBuilder.Entity("StandingOut.Data.Models.RoleTypeNotificationMessage", b =>
                {
                    b.Property<Guid>("RoleTypeNotificationMessageId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("RoleTypeNotificationMessageId");

                    b.ToTable("RoleTypeNotificationMessages");
                });
            ...
            modelBuilder.Entity("StandingOut.Data.Models.SubscriptionNotificationMessage", b =>
                {
                    b.Property<Guid>("SubscriptionNotificationMessageId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("SubscriptionNotificationMessageId");

                    b.ToTable("SubscriptionNotificationMessages");
                });
            ...
            modelBuilder.Entity("StandingOut.Data.Models.UserNotificationMessage", b =>
                {
                    b.Property<Guid>("UserNotificationMessageId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("UserNotificationMessageId");
            ...
            modelBuilder.Entity("StandingOut.Data.Models.WebsiteContact", b =>
                {
                    b.Property<Guid>("WebsiteContactId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("WebsiteContactId");

                    b.HasIndex("StudyLevelId");

                    b.HasIndex("SubjectId");

                    b.ToTable("WebsiteContacts");
                });
            ...
            modelBuilder.Entity("StandingOut.Data.Models.UserNotificationMessage", b =>
                {
                    b.HasOne("StandingOut.Data.Models.NotificationMessage", "NotificationMessage")
                        .WithMany()
